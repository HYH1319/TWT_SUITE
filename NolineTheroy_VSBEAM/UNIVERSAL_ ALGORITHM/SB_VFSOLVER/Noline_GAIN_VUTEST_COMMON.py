...
from _TWT_CORE_NOLINE_COMPLEX_VSHEETBEAM_VFTSS import solveTWTNOLINE_INIT
from Noline_GAIN_MAINCALL_VUCORE_ import Noline_CORE_CALC
...
if __name__ == "__main__":
    ...
    if (
        ...
        Rn_sqr_values = initparamater["等离子体频率降低因子Fn"]**2
