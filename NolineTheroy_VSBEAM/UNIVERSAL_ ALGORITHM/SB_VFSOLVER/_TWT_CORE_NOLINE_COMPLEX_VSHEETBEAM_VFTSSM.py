# -*- coding: utf-8 -*-
"""
最终优化版 TWT 非线性带状束流求解器 (Scipy DOP853 优化版)
...
def solveTWTNOLINE_INIT(C, b, d, beam_params, m, A0, y_end, N_steps=1000):
    ...
    def ode_system(y, state):
        ...
        Ez = compute_Esp_VR(phi, denominator, delta_phi0, C, b, m, beam_params)
