...
from _TWT_CORE_NOLINE_COMPLEX_VSHEETBEAM_VFTSS import (
...
def calculate_SEGMENT_TWT_NOLINE(
    ...
    for seg_idx, seg in enumerate(SEGMENTS):
        ...
        if (w == t):  # 行波管等离子体频率降低系数R,ShitBeam用Fn,CicularBeam用Rowe特征值R
...
if __name__ == "__main__":
    ...
    result = calculate_SEGMENT_TWT_NOLINE(*inputPS)
    print("计算结果:", result)
