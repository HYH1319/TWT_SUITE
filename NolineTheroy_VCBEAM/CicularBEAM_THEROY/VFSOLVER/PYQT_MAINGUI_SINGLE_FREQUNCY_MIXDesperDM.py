...
class TWT_GUI:
        ...
        try:
            ...
            for seg_idx, seg in enumerate(SEGMENTS):
                ...
                params = {
                    ...
                    "Fill_Rate": seg["Fn_K"], "p_SWS": seg["p_SWS"] * 1e-3, "m": 64, "Space_cut": 20,
    ...
    def visualize_results(self, Y, A, theta, u, phi,Lenth, P_Out, P_in, final_seg):
        ...
        ax_phase_dist.plot(Y, phi, 'navy'); ax_phase_dist.set_xlabel("Position y"); ax_phase_dist.set_ylabel("Electron Phase"); ax_phase_dist.set_title("Electron Phase Space"); ax_phase_dist.grid(alpha=0.3)
