...
from _TWT_CORE_NOLINE_COMPLEX_VSUPER_MIX_VFTSS import solveTWTNOLINE_OUTPUT, solveTWTNOLINE_INIT,solveTWTNOLINE_Drift

def main():
    # ========================= 多段参数配置 =========================
    SEGMENTS = [
        {"len": 30, "Vpc": 0.288, "p_SWS": 0.50, "Kc": 3.6, "Loss_perunit": 0, "type": "initial"},
        {"len": 5, "Vpc": 0.287136, "p_SWS": 0.495, "Kc": 3.5676, "Loss_perunit": 0, "type": "attenuator"},
        {"len": 5, "Vpc": 0.286272, "p_SWS": 0.490, "Kc": 3.5352, "Loss_perunit": 0, "type": "O"},
        {"len": 5, "Vpc": 0.285408, "p_SWS": 0.485, "Kc": 3.5028, "Loss_perunit": 0, "type": "O"},
        {"len": 5, "Vpc": 0.284544, "p_SWS": 0.480, "Kc": 3.4704, "Loss_perunit": 0, "type": "O"},
    ]
    Loss_attu = 20

    # ========================= 全局参数 =========================
    COMMON_PARAMS = {
        "I": 0.3, "V": 23000,"Fn_K": 1, 
