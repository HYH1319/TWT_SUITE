...
class HarmonicParamsEditor(BaseEditor):
    ...
    def __init__(self, parent=None):
        fields = [
            ...
            ("━━━ 倍频耦合阻抗 (Kc) ━━━", "label"),
            ("倍频前 Kc值 (Ω):", "double", 0, 10, 0.363, 0.001, 4),
            ("倍频段 Kc值 (Ω):", "double", 0, 10, 1.82, 0.001, 4),
            
            ("━━━ 倍频单元损耗 ━━━", "label"),
            ("倍频前 每单元损耗:", "double", 0, 1e3, 0.1, 0.001, 4),
            ("倍频段 每单元损耗:", "double", 0, 1e3, 0.25, 0.001, 4),
            
            ("━━━ 倍频填充因子 ━━━", "label"),
            ("倍频前 填充因子:", "double", 1, 10, 2.0, 0.001, 4),
            ("倍频段 填充因子:", "double", 1, 10, 1.1, 0.001, 4),
            
            ("━━━ 倍频相速度 (Vpc) ━━━", "label"),
            ("倍频前 Vpc值 (c):", "double", 0, 1, 0.2887, 0.0001, 5),
            ("倍频段 Vpc值 (c):", "double", 0, 1, 0.2902, 0.0001, 5),
        ]
        super().__init__(fields, parent)
...
class TWTMainWindow(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("倍频行波管分布式差分进化优化工具 (优化版 v2.0)")
    ...
    def start_optimization(self):
        ...
        self.log_area.append("  倍频行波管分布式差分进化优化 -  v2.0")
        self.log_area.append("=" * 60)
