...
from TWT_CORE_SIMP import detailed_calculation as Noline_CALC
...
class TWTCalculator(QMainWindow):
    ...
    def init_ui(self):
        """初始化用户界面"""
        self.setWindowTitle('线性TWT计算器 v4.2 (PyQt5),带状束流圆形束流通吃')
            ...
            try:
                ...
                for param_idx, params in enumerate(var_params, 1):
                    try:
                        ...
                        valid_results.append( (params['Freq'], result['Gmax']) )
