...
from _TWT_CORE_NOLINE_COMPLEX_VSHEETBEAM import solveTWTNOLINE_Drift,solveTWTNOLINE_OUTPUT, solveTWTNOLINE_INIT
...
def get_Rn_sqr_values(calc_result, w, t):
    """获取等离子体频率因子"""
    return calc_result["Rowe特征值R"]**2 if w == t else calc_result["等离子体频率降低因子Fn"]
